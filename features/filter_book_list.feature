...
Scenario: restrict to books with 'PG' or 'R' genres
  When I check the following genres: PG, R
  And  I uncheck the following genres: G, PG-13
  And  I press "Refresh"
...
Scenario: all genres selected
  When I check the following genres: G, R, PG-13, PG
  And  I press "Refresh"
